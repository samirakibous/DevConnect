                ...
                <div class="bg-white rounded-lg shadow-md p-6 hidden " id="AddPostForm">
                    ...
                    <form action="{{ route('posts.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                                ...
                                <select name="tags[]" id="tags" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" multiple>
                        ...
                        <div class="mb-6 border border-gray-200 rounded-lg p-4">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <label for="allow_comments" class="ml-2 text-sm text-gray-700">Allow comments on this post</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="feature_post" name="feature_post"
                                        class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                    <label for="feature_post" class="ml-2 text-sm text-gray-700">Feature this post on homepage</label>
                                </div>
                                <div>
